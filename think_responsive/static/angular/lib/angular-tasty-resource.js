 ...
 */
angular.module('ngTastyResource', ['ng']).
  factory('$tasty_resource', ['$http', '$parse', function($http, $parse) {
    var DEFAULT_ACTIONS = {
      'get':    {method:'GET'},
      'save':   {method:'POST'},
      'query':  {method:'GET', isArray:true},
    ...
    function ResourceFactory(url, paramDefaults, actions) {
      ...
      forEach(actions, function(action, name) {
        ...
        Resource[name] = function(a1, a2, a3, a4) {
          ...
          var value = this instanceof Resource ? this : (action.isArray ? {objects: [], meta: {}} : new Resource(data));
          $http({
            ...
            headers: extend({}, action.headers || {})
              ...
              if (data) {
                if (action.isArray) {
                  ...
                  forEach(data.objects, function(item) {
                    value.objects.push(new Resource(item));
                  });
                } else {
                  copy(data, value);
                }
